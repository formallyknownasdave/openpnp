...
import org.openpnp.machine.starmachine.wizards.StarNozzleTipCalibrationWizard;
...
public class StarNozzleTip extends AbstractNozzleTip {
    ...
    @Element(required = false)
    private StarNozzleTipCalibration calibration = new StarNozzleTipCalibration();
    ...
    public StarNozzleTip() {
        Configuration.get().addListener(new ConfigurationListener.Adapter() {

            @Override
            public void configurationLoaded(Configuration configuration) throws Exception {
                nozzleTipLocator = (ReferenceNozzleTipLocator) configuration.getMachine().getNozzleTipLocator(nozzleTipLocatorId);
            }
        });
    }
        ...
        if (methodPartOff == null) {
            ...
            try {
                ...
                Nozzle nozzle = Configuration.get()
                        ...
                        .getDefaultHead()
                        .getDefaultNozzle();
                if (nozzle instanceof StarNozzle) {
                    StarNozzle refNozzle = (StarNozzle) nozzle;
    ...
    public Wizard getConfigurationWizard() {
        return null;//new ReferenceNozzleTipConfigurationWizard(this);
    }
    ...
    public PropertySheet[] getPropertySheets() {
        return new PropertySheet[] {
                ...
                //new PropertySheetWizardAdapter(new StarNozzleTipPartDetectionWizard(this), "Part Detection"),
                //new PropertySheetWizardAdapter(new StarNozzleTipToolChangerWizard(this), "Tool Changer"),
                new PropertySheetWizardAdapter(new StarNozzleTipCalibrationWizard(this), "Calibration")
        };
    }
    ...
    public StarNozzle getNozzleAttachedTo() {
        for (Head head : Configuration.get().getMachine().getHeads()) {
            for (Nozzle nozzle : head.getNozzles()) {
                if (nozzle instanceof StarNozzle) {
                    ...
                    if (this == ((StarNozzle)nozzle).getCalibrationNozzleTip()) {
                        return ((StarNozzle)nozzle);
                    }
                }
            }
        }
    ...
    public ReferenceNozzleTipLocator getNozzleTipLocator() {
        return nozzleTipLocator;
    }

    public void setNozzleTipLocator(ReferenceNozzleTipLocator locator) {
        Object oldValue = this.nozzleTipLocator;
        this.nozzleTipLocator = locator;
        this.nozzleTipLocatorId = (locator == null) ? null : locator.getId();
        firePropertyChange("nozzleTipLocator", oldValue, locator);
    }
    ...
    public StarNozzleTipCalibration getCalibration() {
        return calibration;
    }
    ...
    public Action loadAction = new AbstractAction("Load") {
        ...
        public void actionPerformed(final ActionEvent arg0) {
            UiUtils.submitUiMachineTask(() -> {
                MainFrame.get().getMachineControls().getSelectedNozzle().loadNozzleTip(StarNozzleTip.this);
            });
        }
    };
    ...
    public Action deleteAction = new AbstractAction("Delete Nozzle Tip") {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                Configuration.get().getMachine().removeNozzleTip(StarNozzleTip.this);
            }
        }
    };
    ...
    public void home() throws Exception {
        /*if (getVisionCalibrationTrigger() != ReferenceNozzleTip.VisionCalibrationTrigger.Manual) {
